        ...
        <div className="min-h-screen bg-slate-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center space-x-2 bg-slate-800 border border-slate-700 rounded-full px-4 py-2 mb-6">
                        <Sparkles className="w-4 h-4 text-slate-400" />
                        <span className="text-sm text-slate-300 font-medium">Phase 1 Complete</span>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
                    ...
                    <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 hover:border-slate-600 transition-all">
                        <div className="text-4xl font-bold text-white mb-2">Base</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {docs.map(doc => (
                            <button
                                ...
                                className="group relative bg-slate-800/50 backdrop-blur-sm border border-slate-700 hover:border-slate-600 rounded-2xl p-8 transition-all text-left overflow-hidden"
                            >
                                {/* Gradient overlay on hover */}
                                <div className={`absolute inset-0 ${doc.color} opacity-0 group-hover:opacity-5 transition-opacity`}></div>
                                ...
                                {/* Icon */}
                                <div className={`relative w-16 h-16 ${doc.color} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-lg`}>
                                    <doc.icon className="w-8 h-8 text-white" />
                                </div>

                                {/* Content */}
                                <h3 className="relative text-2xl font-bold text-white mb-3 transition-all">
                                    {doc.title}
                                </h3>
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <a
                            ...
                            className="group flex items-center justify-between p-4 bg-slate-900/50 hover:bg-slate-800 border border-slate-700 hover:border-slate-600 rounded-xl transition-all"
                        >
